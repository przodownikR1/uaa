...
public class CircuitController {
	...
	*/
	...
	@GetMapping("/service")
	public String service(@RequestHeader(value = "X-SelfToken", required = false) String token)
	 ...
	 * "executionIsolationStrategy", value = "THREAD") }) public int
	 * getThreadId() { return Thread.currentThread().hashCode(); }
	 */
